...
$_LANG['addfunds'] = "Tambahkan Dana";
$_LANG['addfundsamount'] = "Jumlah akan Ditambahkan";
...
$_LANG['addfundsmaximumerror'] = "Jumlah Setoran Maksimum adalah";
$_LANG['addfundsminimum'] = "Setoran Minimum";
$_LANG['addfundsminimumerror'] = "Jumlah Setoran Minimum adalah";
$_LANG['addmore'] = "Tambah Lainnya";
$_LANG['addtocart'] = "Tambahkan ke Troli";
$_LANG['affiliatesactivate'] = "Aktifkan Akun Afiliasi";
$_LANG['affiliatesamount'] = "Jumlah";
$_LANG['affiliatesbalance'] = "Saldo saat Ini";
$_LANG['affiliatesbullet1'] = "Terima setoran bonus awal di akun afiliasi Anda dari";
$_LANG['affiliatesbullet2'] = "dari setiap pembayaran yang dilakukan oleh tiap pelanggan yang Anda referensikan kepada kami sesuai durasi akun hosting mereka";
$_LANG['affiliatescommission'] = "Komisi";
$_LANG['affiliatesdescription'] = "Bergabung dengan program afiliasi Kami atau lihat penghasilan";
$_LANG['affiliatesdisabled'] = "Saat ini kami tidak memiliki penawaran sistem afiliasi kepada klien Kami.";
$_LANG['affiliatesearn'] = "Pendapatan";
$_LANG['affiliatesearningstodate'] = "Total Penghasilan sampai Saat ini";
$_LANG['affiliatesfootertext'] = "Ketika Anda merujuk seseorang ke situs web kami dengan ID rujukan unik Anda, cookie ditempatkan di komputer mereka yang berisi ID ini jadi jika mereka menandai situs dan kembali lagi nanti Anda akan tetap menerima komisi.";
$_LANG['affiliateshostingpackage'] = "Paket Hosting";
$_LANG['affiliatesintrotext'] = "Aktifkan akun afiliasi Anda hari ini untuk:";
$_LANG ['afiliasiateslinktous'] = "Tautan ke Kami";
$_LANG ['afiliasiatesnosignups'] = "Saat ini Anda belum menerima pendaftaran afiliasi";
$_LANG ['afiliasiatesrealtime'] = "Statistik ini berdasarkan waktu sebenarnya dan diperbarui secara instan";
$_LANG ['afiliasiatesreferallink'] = "Tautan Afiliasi Unik Anda";
$_LANG ['afiliasiatesreferals'] = "Referensi Anda";
$_LANG ['afiliasiatesregdate'] = "Tanggal Registrasi";
$_LANG ['afiliasiatesrequestwithdrawal'] = "Minta Penarikan";
$_LANG ['affiliateatessignupdate'] = "Tanggal Pendaftaran";
$_LANG ['affiliateatesstatus'] = "Status";
$_LANG ['affiliateatestitle'] = "Afiliasi";
$_LANG ['affiliatesvisitorsreferred'] = "Jumlah Pengunjung Yang Direferensikan";
$_LANG ['afiliasiateswithdrawalrequestsuccessful'] = "Permintaan Anda untuk penarikan telah dikirim. Anda akan segera dihubungi.";
$_LANG ['affiliateateswithdrawn'] = "Total Jumlah Yang Ditarik";
$_LANG ['all'] = "Semua";
$_LANG ['alreadyregistered'] = "Sudah Terdaftar?";
$_LANG ['annoementsdescription'] = "Lihat berita & pengumuman terbaru kami";
$_LANG ['annoementsnone'] = "Tidak Ada Pengumuman untuk Ditampilkan";
$_LANG ['annoementsrss'] = "Lihat RSS Feed";
$_LANG ['annostitle'] = "Pengumuman";
$_LANG ['bannedbanexpires'] = "Larangan Kedaluwarsa";
$_LANG ['bannedbanreason'] = "Alasan Larangan";
$_LANG['bannedhasbeenbanned'] = "telah dilarang";
$_LANG['bannedtitle'] = "IP Terlarang";
$_LANG['bannedyourip'] = "IP Anda";
$_LANG['cartaddons'] = "Tambahan";
$_LANG['cartbrowse'] = "Jelajah Produk &amp; Layanan";
$_LANG['cartconfigdomainextras'] = "Konfigurasikan Domain Ekstra";
$_LANG ['cartconfigoptionsdesc'] = "Produk / layanan ini memiliki beberapa opsi yang dapat Anda pilih di bawah ini untuk menyesuaikan pesanan Anda.";
$_LANG ['cartconfigserver'] = "Konfigurasi Server";
$_LANG ['cartcustomfieldsdesc'] = "Produk / layanan ini memerlukan beberapa informasi tambahan agar kami dapat memproses pesanan Anda.";
$_LANG ['cartdomainsconfig'] = "Konfigurasi Domain";
$_LANG ['cartdomainsconfigdesc'] = "Di bawah ini Anda dapat mengonfigurasi nama domain dalam keranjang belanja Anda dengan memilih layanan addon yang Anda inginkan, memberikan informasi yang diperlukan dan menentukan nameserver yang akan digunakan.";
$_LANG ['cartdomainshashosting'] = "Punya Hosting";
$_LANG ['cartdomainsnohosting'] = "Tidak Ada Hosting! Klik untuk Tambah";
$_LANG ['carteditproductconfig'] = "Edit Konfigurasi";
$_LANG ['cartempty'] = "Troli Belanja Anda Kosong";
$_LANG ['cartemptyconfirm'] = "Apakah Anda yakin ingin mengosongkan keranjang belanja Anda?";
$_LANG ['cartexistingclientlogin'] = "Login sebagai Klien";
$_LANG ['cartexistingclientlogindesc'] = "Untuk menambahkan pesanan ini ke akun Anda, silahkan Logine terlebih dahulu.";
$_LANG ['cartnameserversdesc'] = "Jika Anda ingin menggunakan nameserver kustom, silahkan masukkan di bawah ini. Secara default, domain baru akan menggunakan nameserver untuk hosting di jaringan kami.";
$_LANG ['cartproductaddons'] = "Penambahan Produk";
$_LANG ['cartproductaddonschoosepackage'] = "Pilih Paket";
$_LANG ['cartproductaddonsnone'] = "Tidak Ada Opsi Tambahan yang Tersedia untuk Produk & Layanan Anda;"
...
$_LANG ['cartproductdomaindesc'] = "Produk / layanan yang Anda pilih memerlukan nama domain. Silakan masukkan nama domain Anda di bawah ini.";
$_LANG ['cartproductdomainuseincart'] = "Gunakan nama domain yang ada di keranjang belanja saya";
$_LANG ['cartremove'] = "Hapus";
$_LANG ['cartremoveitemconfirm'] = "Apakah Anda yakin ingin menghapus item ini dari keranjang Anda?";
$_LANG ['carttaxupdateselections'] = "Pajak mungkin dibebankan tergantung pada negara bagian dan pilihan negara yang Anda buat. Klik untuk menghitung ulang setelah membuat pilihan Anda.";
$_LANG ['carttaxupdateselectionsupdate'] = "Perbarui";
$_LANG ['carttitle'] = "Daftar Belanja";
$_LANG ['changessavedsuccessfully'] = "Perubahan Berhasil Disimpan!";
$_LANG ['checkavailable'] = "Periksa Ketersediaan";
